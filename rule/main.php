    ...
    <div class="card text-center">
        <div class="col-md-12">
            <h2 class="header-title">
                <p></p>
                <span class="text-info">ระบบจัดการความประพฤติ ฝ่ายปกครอง</span>
                <p></p>
...
<!--            <h4 class="card-title show-font">รายงานการตัดคะแนนความประพฤติ</h4>-->
            <div class="card-body">
                ...
                <button class="btn btn-primary" data-provide="loader" data-url="tb_rule.php" data-target="#loader-target" style="display: none"  id="button-late">Button</button>
