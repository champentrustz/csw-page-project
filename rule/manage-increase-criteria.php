    ...
    <div class="card text-center">
        <div class="col-md-12">
            <h2 class="header-title">
                <p></p>
                <span class="text-info">จัดการเกณฑ์การเพิ่มคะแนนความประพฤติ</span>
                <p></p>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-primary" data-provide="loader" data-url="tb_increase_criteria.php" data-target="#loader-target" style="display: none"  id="button-late">Button</button>
