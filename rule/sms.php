...
$sql_sms = "SELECT * FROM tb_sms WHERE date = '".$date_day."'";
...
<main class="main-container">
    ...
    <div class="card text-center">
        <div class="col-md-12">
            <h2 class="header-title">
                <p></p>
                <span class="text-info">ส่ง SMS ประจำวัน</span>
    ...
    <div class="container">
        <div class="card">
            <h4 class="card-title show-font">สถานะการส่ง SMS :
                ...
                <div class="card-body">
                    ...
                    <p><a class="btn btn-primary col-md-3" href="function_send_sms.php"><span class="show-font">ส่ง SMS</span></a></p>
        ...
        <div class="card">
            <h4 class="card-title show-font">รายงานการส่ง SMS ประจำวัน</h4>
            <div class="card-body">
                <div class="table-responsive-lg" style="font-size: 16px">
                    <table class="table table-lg table-hover table-bordered" data-page-length='100' data-provide="datatables">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><img class="zoom" src="../file_student/small/<?php print $data['student_code']?>.jpg" style="width:60px;height:78px"></td>
                            <td><?php print $data['student_name']?></td>
                            <td class="text-center"><?php print $data['room']?></td>
                            <td class="text-center"><?php print $data['description']?></td>
                        </tr>
