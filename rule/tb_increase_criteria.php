    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title show-font" id="myModalLabel">เพิ่มเกณฑ์การเพิ่มคะแนนความประพฤติ</h4>
            ...
            while ($row_rule_type = mysqli_fetch_assoc($result_rule_type)) {
                ...
                <div class="modal fade" id="modal-edit-<?php print $row_rule_type['tb_ruletype_id']?>" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title show-font" id="myModalLabel">แก้ไขเกณฑ์การเพิ่มคะแนนความประพฤติ</h4>
                                <button type="button" class="close" data-dismiss="modal">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
